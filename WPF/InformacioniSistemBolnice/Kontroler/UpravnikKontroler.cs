...
namespace Kontroler
{
    public class UpravnikKontroler
    {
        ...
        public void KreiranjeDinamickeOpreme(DinamickaOpremaDto dto) { DinamickaOpremaServis.Instance.KreiranjeOpreme(dto); }
        public void BrisanjeDinamickeOpreme(DinamickaOpremaDto dto) { DinamickaOpremaServis.Instance.UklanjanjeOpreme(dto); }
        public void IzmenaDinamickeOpreme(DinamickaOpremaDto dto) { DinamickaOpremaServis.Instance.IzmenaOpreme(dto); }
        public void RasporedjivanjeDinamickeOpreme(RaspodelaDinamickeOpremeDto dto) { Servis.RaspodelaDinamickeOpremeServis.Instance.Premestanje(dto); }
        public void RasporedjivanjeStatickeOpreme(RaspodelaStatickeOpremeDto dto) { Servis.RaspodelaStatickeOpremeServis.Instance.ZakazivanjePremestanja(dto); }
        ...
        {
            LekServis.Instance.IzmenaLeka(dto);
        }
