...
namespace Model
{
    public class AnketaOBolnici
    {
        ...
        public AnketaOBolnici(int ljubaznost, int profesionalizam, int strpljenje, int komunikativnost, int azurnost,
            int korisnost, string generalniKomentari, string pacijentovJmbg, DateTime vremePopunjavanja)
        {
